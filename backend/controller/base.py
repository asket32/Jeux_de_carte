...
class ControleurJeu:
    ...
    def reinitialiser_partie(self):
        # Vide les mains et remet cartes dans le paquet
        for joueur in self.joueurs:
        ...
        self.partie_commencee = False
        self.partie_terminee = False
        # Si tu veux, tu peux aussi réinitialiser complètement les joueurs :
        self.joueurs = []
    ...
    def etat_partie(self) -> dict:
        return {
            ...
            "joueurs": [
                {"nom": j.nom, "main": j.montrer_main()} for j in self.joueurs
            ]
        }
